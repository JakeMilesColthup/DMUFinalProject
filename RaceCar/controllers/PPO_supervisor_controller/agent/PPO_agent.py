...
class PPOAgent:
    ...
    def __init__(self, number_of_inputs, number_of_actor_outputs, clip_param=0.2, max_grad_norm=0.5, ppo_update_iters=5,
        ...
        # In case want to fix randomness
        if seed is not None:
            manual_seed(seed)
    ...
    def train_step(self, batch_size=None):
        ...
        # After each training step, clear the buffer
        del self.buffer[:]
...
class Actor(nn.Module):
    def __init__(self, number_of_inputs, numberOfOutputs):
        ...
        self.fc1 = nn.Linear(number_of_inputs, 32)
        self.fc2 = nn.Linear(32, 32)
        self.action_head = nn.Linear(32, numberOfOutputs)
